...
const Solutionimg = () => {
  return (
    <div className="relative w-full ">
      ...
      <img
        ...
        className="lg:h-[60%] w-full h-96 object-cover"
  ...
  style={{ backgroundImage: "url('/assets/background.jpg')" }}
    ...
    >
      ...
      >
        <h1 className="md:text-4xl text-3xl font-bold text-gray-800 ">Terms & Conditions</h1>
        ...
        <h2 className="mt-6 text-xl  font-semibold text-orange-600">Your Agreement</h2>
        ...
        <div className="mt-8 border-t border-gray-300 pt-6">
          <h2 className="text-xl font-semibold text-orange-600">Privacy</h2>
        ...
        <div className="mt-8 border-t border-gray-300 pt-6">
          <h2 className="text-xl font-semibold text-orange-600">Linked Sites</h2>
          <p className="text-gray-600 mt-2">
            Please review our Privacy Policy, which also governs your visit to this Site, to understand our practices.
          </p>
        </div>
        ...
        <div className="mt-8 border-t border-gray-300 pt-6">
          <h2 className="text-xl font-semibold text-orange-600">Forward Looking Statements</h2>
          <p className="text-gray-600 mt-2">
